...
$sql = "SELECT fd.Fid AS Fid,fd.location as cure, fd.name,fd.phoneno,fd.date,fd.delivery_by, fd.food, fd.address as From_address, 
            ...
            <td data-label="Action" style="margin:auto">
                <?php if ($row['delivery_by'] == null) { ?>
                    <form method="post" action=" ">
                        ...
                        <button type="submit" name="food">Accept Donation</button>
                    </form>
